...
This project uses **React**, **Vite**, **Tailwind CSS**, **React-router-dom**, **Headless UI**, and **Heroicons**.
...
```bash
<script setup>
import { Bars3Icon, BellIcon, XMarkIcon, ShoppingBagIcon, UserIcon } from '@heroicons/react/24/outline'
</script>
...
👉 **[documentation](https://headlessui.com/v1/react)**
